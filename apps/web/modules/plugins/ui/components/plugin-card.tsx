  ...
  return (
    <div className="h-fit w-full rounded-lg border bg-background p-8">
      <div className="mb-6 flex items-center justify-center gap-6">
        ...
        <div className="flex flex-col items-center">
          <Image alt="Platform" className="object-contain" height={40} width={40} src="/logo.svg" />
        </div>
      </div>
      ...
      <Button className="w-full" disabled={isDisabled} onClick={onSubmit} variant="default">
        Connect
        <PlugIcon />
      </Button>
    </div>
